...
/*   Updated: 2025/03/25 08:44:56 by rguigneb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::display(void) const
{
	...
	std::cout << "hit points : " << std::setw(10) << std::right << this->_hit_points << std::endl;
	std::cout << "attack damages : " << std::setw(10) << std::right << this->_attack_damage << std::endl;
	std::cout << "energy points " << std::setw(10) << std::right << this->_energy_points << std::endl;
	std::cout << "------------------------------------" << std::endl;
}
